<div class="alert alert-info alert-dismissible fade show" role="alert" style="width:100%" id='notempty'>
    <strong>Ghi chú!</strong> Nếu không phải về vấn đề đơn hàng thì mã đơn = 0	
				...
				<table class="table-striped table-bordered col-md-12 text-center">
                    ...
                    <tbody>
                        <?php
                            ...
                            if($count==0) {
                              ?><script> document.getElementById("notempty").innerHTML = '<div class="alert alert-info alert-dismissible fade show" role="alert" style="width:100%"> Bạn chưa nhận được lời nhắn nào	</div>';
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" style="background-color: rgb(111 202 203);">
            <h5 class="modal-title" id="reply<?php echo $contactId; ?>">Phản hồi (Contact Id: <?php echo $contactId; ?>)</h5>
          ...
          <div class="modal-body">
            <form action="partials/_contactManage.php" method="post">
                <div class="text-left my-2">
                    <b><label for="message">Lời nhắn: </label></b>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(187 188 189);">
              <h5 class="modal-title" id="history">Tin nhắn bạn đã gửi</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            ...
            <table class="table-striped table-bordered col-md-12 text-center">
                ...
                <?php 
                    ...
                    if($totalReply==0) {
                      ?><script> document.getElementById("notReply").innerHTML = '<div class="alert alert-info alert-dismissible fade show" role="alert" style="width:100%"> Bạn chưa trả lời tin nhắn nào!	</div>';</script> <?php
                    }   
