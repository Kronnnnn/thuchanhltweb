					...
					<div class="card mb-3">
						...
						<div class="card-body">
							<div class="form-group">
								<label class="control-label">Tên quần áo: </label>
						...
						<div class="card-footer">
							<div class="row">
								<div class="mx-auto">
									<button type="submit" name="createItem" class="btn btn-sm btn-primary"> Thêm
									</button>
								</div>
							</div>
						</div>
						...
						<table class="table table-bordered table-hover mb-0">
							<thead style="background-color: rgb(111 202 203);">
								<tr>
									...
									<th class="text-center" style="width:58%;">Chi tiết quần áo</th>
							...
							<tbody>
								...
								while ($row = mysqli_fetch_assoc($result)) {
									...
									echo '<tr>
                                            ...
                                            <td>
                                                <img src="/fashion/img/pizza-' . $pizzaId . '.jpg" alt="image for this item" width="150px" height="150px">
                                            </td>
                                            <td>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header" style="background-color: rgb(111 202 203);">
					<h5 class="modal-title" id="updateItem<?php echo $pizzaId; ?>">ID:
						<?php echo $pizzaId; ?>
					</h5>
				...
				<div class="modal-body">
					<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
						<div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
							<div class="form-group col-md-8">
								...
								<button type="submit" class="btn btn-success my-1" name="updateItemPhoto">Cập nhập
									hình</button>
							</div>
							<div class="form-group col-md-4">
								<img src="/fashion/img/pizza-<?php echo $pizzaId; ?>.jpg" id="itemPhoto" name="itemPhoto"
					...
					<form action="partials/_menuManage.php" method="post">
						<div class="text-left my-2">
							<b><label for="name">Tên quần áo</label></b>
						...
						<div class="text-left my-2 row">
							<div class="form-group col-md-6">
								...
								<input class="form-control" id="price" name="price" value="<?php echo $pizzaPrice; ?>"
