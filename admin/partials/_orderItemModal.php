...
while ($itemModalRow = mysqli_fetch_assoc($itemModalResult)) {
    ...
    <div class="modal fade" id="orderItem<?php echo $orderid; ?>" tabindex="-1" role="dialog"
        aria-labelledby="orderItem<?php echo $orderid; ?>" aria-hidden="true" style="width: -webkit-fill-available;">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: rgb(111 202 203);">
                    <h5 class="modal-title" id="orderItem<?php echo $orderid; ?>">Chi tiết đơn hàng (<b>Mã đơn hàng:
                            <?php echo $orderid; ?>
                        </b>)</h5>
                                    ...
                                    <tbody>
                                        ...
                                        while ($myrow = mysqli_fetch_assoc($myresult)) {
                                            ...
                                            echo '<tr>
                                                <th scope="row">
                                                    <div class="p-2">
                                                    <img src="/fashion/img/pizza-' . $pizzaId . '.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
