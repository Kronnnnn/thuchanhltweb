      ...
      <div class="modal-body">
        <form action="partials/_orderManage.php" method="post" style="border-bottom: 2px solid #dee2e6;">
            <div class="text-left my-2">    
                ...
                <button type="button" class="btn btn-secondary ml-1" data-container="body" data-toggle="popover" title="User Types" data-placement="bottom" data-html="true" data-content="0=Đã đặt hàng.<br> 1=Đã xác nhận đơn hàng.<br> 2=Đang chuẩn bị đơn hàng.<br> 3=Đơn hàng của bạn đang được vận chuyển!<br> 4=Đã giao hàng.<br> 5=Giao hàng thất bại.<br> 6=Đơn hàng đã huỷ.">
