    ...
    <div class="row">
        <div class="col-lg-12">
            <button class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#newUser"><i
                    class="fa fa-plus"></i> Tạo tài khoản</button>
        </div>
    </div>
    <br>
    <div class="row">
                ...
                <table class="table-striped table-bordered col-md-12 text-center">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<tr>
                                    <td>' . $Id . '</td>
                                    <td><img src="/fashion/img/person-' . $Id . '.jpg" alt="image for this user" onError="this.src =\'/fashion/img/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' . $username . '</td>
                                    <td>
            ...
            <div class="modal-body">
                <form action="partials/_userManage.php" method="post">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="username" name="username" placeholder="Nhập tài khoản"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="cpassword" name="cpassword" placeholder="Nhập lại mật khẩu"
                            type="password" required data-toggle="password" minlength="4" maxlength="21">
                    </div>
...
while ($userRow = mysqli_fetch_assoc($userResult)) {
    ...
    <div class="modal fade" id="editUser<?php echo $Id; ?>" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: rgb(111 202 203);">
                    <h5 class="modal-title" id="editUser<?php echo $Id; ?>">Mã tài khoản: <b>
                            <?php echo $Id; ?>
                        </b></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    ...
                    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                        <div class="form-group col-md-8">
                            <form action="partials/_userManage.php" method="post" enctype="multipart/form-data">
                                ...
                                <button type="submit" class="btn btn-success mt-3" name="updateProfilePhoto">Cập nhật ảnh
                                    đại diện</button>
                            </form>
                        </div>
                        <div class="form-group col-md-4">
                            <img src="/fashion/img/person-<?php echo $Id; ?>.jpg" alt="Profile Photo" width="100"
                                height="100" onError="this.src ='/fashion/img/profilePic.jpg'">
                            <form action="partials/_userManage.php" method="post">
                                <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
                                <button type="submit" class="btn btn-success mt-2" name="removeProfilePhoto">Xoá ảnh đại
                                    diện</button>
                            </form>
                        </div>
                    </div>
