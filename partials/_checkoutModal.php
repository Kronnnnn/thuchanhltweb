...
<div class="modal fade" id="checkoutModal" tabindex="-1" role="dialog" aria-labelledby="checkoutModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="checkoutModal">Thông tin của bạn:</h5>
        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
                <div class="form-group">
                    <b><label for="address">Số nhà:</label></b>
                    <input class="form-control" id="address" name="address" placeholder="180 Cao Lỗ" type="text" required minlength="3" maxlength="500">
                </div>
                <div class="form-group">
                    <b><label for="address1">Quận/huyện, thành phố:</label></b>
                    <input class="form-control" id="address1" name="address1" placeholder="F4,Q8,TPHCM" type="text">
                </div>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6 mb-0">
                        <b><label for="zipcode">Mã vùng:</label></b>
