            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="printThis">
                    <div class="container" style="padding-right: 0px;padding-left: 0px;">
                        <article class="card">
                            <div class="card-body">
                                <h6><strong>Mã đơn hàng:</strong> #
                                    <?php echo $orderid; ?>
                                </h6>
                                <article class="card">
                                    <div class="card-body row">
                                        <div class="col"> <strong>Thời gian giao hàng dự kiếN:</strong> <br>
                                            <?php echo $deliveryTime; ?> minute
                                        </div>
                                        <div class="col"> <strong>Đơn vị vận chuyển:</strong> <br>
                                ...
                                <a href="contact.php" class="btn btn-warning" data-abc="true">Cần giúp đỡ <i
