...
<body>
    ...
    <?php 
        ...
        <div class="alert alert-info my-3">
            <font style="font-size:22px"><center>Vui lòng <strong><a class="alert-link" data-toggle="modal" data-target="#loginModal"> đăng nhập</a></strong></center></font>
        </div></div>';
    }
    ?>
